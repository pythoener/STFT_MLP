...
import joblib                                   # <-- add
feature_scaler = joblib.load('feature_scaler_vctk.pkl') # file you dumped in training
...
model = load_model('Model_VCTK.h5')
...
def processfile(file_path):
    ...
    try:
        ...
        save_audio(reconstructed_audio, file_path, r'C:\Users\HPC3\PycharmProjects\mert\STFT_MLP/Results_VCTK', fs)
